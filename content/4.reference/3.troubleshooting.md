...
Defaults and supported flags shifted across v0.10 and v0.11. If a script that worked under an older release now misbehaves, check here first — each subsection notes the release that introduced the change.
