...
**Jump to:** [Global Flags](#global-flags) | [Authentication](#authentication) | [Ports](#ports) | [VXC](#vxc) | [MCR](#mcr) | [MVE](#mve) | [IX](#ix) | [Locations](#locations) | [Partners](#partners) | [Service Keys](#service-keys) | [Config](#config) | [Status](#status)
...
Display the current authentication status and identity — useful for verifying credentials are working.
...
Top-level alias for `auth status`.
