...
::flow-diagram{:steps='[{"icon":"🏢","label":"Data Centre","sub":"Your Equipment","color":"gray"},{"icon":"🔌","label":"Megaport Port","sub":"Equinix SY3 Sydney","color":"teal"},{"icon":"⚡","label":"VXC","sub":"1 Gbps","color":"purple"},{"icon":"🔗","label":"Azure Partner Port","sub":"Megaport hosted","color":"purple"},{"icon":"☁️","label":"ExpressRoute","sub":"Circuit","color":"blue"},{"icon":"🌐","label":"Virtual Network","color":"blue"}]'}
::
