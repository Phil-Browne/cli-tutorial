...
```mermaid
stateDiagram-v2
  [*] --> CONFIGURED: ports buy
  CONFIGURED --> LIVE: fabric provisioning complete
  LIVE --> DECOMMISSIONING: ports delete
  CONFIGURED --> CANCELLED: ports delete (before going live)
  DECOMMISSIONING --> CONFIGURED: ports restore (within window)
  DECOMMISSIONING --> DECOMMISSIONED: billing period ends
  DECOMMISSIONED --> [*]

  style CONFIGURED fill:#1f2937,stroke:#6B2D8B,color:#e2e8f0
  style LIVE fill:#1f2937,stroke:#10b981,color:#e2e8f0
  style DECOMMISSIONING fill:#1f2937,stroke:#f59e0b,color:#e2e8f0
  style DECOMMISSIONED fill:#1f2937,stroke:#ef4444,color:#e2e8f0
  style CANCELLED fill:#1f2937,stroke:#6b7280,color:#e2e8f0
```
