...
```
  ports buy         fabric provisioning       ports delete        billing period ends
─────────────► CONFIGURED ──────────────► LIVE ──────────────► DECOMMISSIONING ──────────────► DECOMMISSIONED
                    │                                               ▲
                    │ ports delete                                   │ ports restore
                    │ (before going live)                            │ (within window)
                    ▼                                               │
                CANCELLED                                    ───────┘
```
