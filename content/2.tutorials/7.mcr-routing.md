...
```text
NEIGHBOR        PEER ASN  LOCAL ASN  STATE        UPTIME
169.254.10.1    65000     64512      ESTABLISHED  00:42:13
169.254.20.1    12076     64512      ESTABLISHED  00:38:47
```

If a session shows `IDLE`, `ACTIVE`, or `OPENSENT` long after provisioning, BGP isn't completing — re-check the peer IP, ASN, MD5 password, and any prefix filter on the cloud side.
...
```bash
megaport-cli mcr looking-glass bgp-neighbor-routes <MCR-UID> 169.254.10.1
```
