...
::flow-diagram{:steps='[{"icon":"🔌","label":"Port","sub":"NextDC S1 · ASN 65001","color":"teal"},{"icon":"⚡","label":"VXC","sub":"2 Gbps","color":"purple"},{"icon":"🌐","label":"MCR","sub":"ASN 64512 · 10 Gbps","color":"purple"}]'}
::

The MCR fans out to three clouds via individual VXCs:

- **AWS** — VXC (1 Gbps) → Direct Connect Gateway → VPC `10.1.0.0/16`
- **Azure** — VXC (1 Gbps) → ExpressRoute Circuit → VNet `10.2.0.0/16`
- **Google Cloud** — VXC (1 Gbps) → Cloud Interconnect → VPC `10.3.0.0/16`
