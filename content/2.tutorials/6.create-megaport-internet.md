...
megaport-cli vxc delete <VXC-UID> --force
```

::info-card{type="note" title="Transit VXCs delete immediately"}
Unlike port-to-port VXCs, Megaport Internet VXCs do not support `--later` (deferred cancellation). Deletion is always immediate.
::
