...
flowchart LR
  ...
  DC --> P --> VXC --> AWS_PP --> DX --> VPC

  style DC fill:#1f2937,stroke:#374151,color:#e2e8f0
  style P fill:#1f2937,stroke:#00BCD4,color:#e2e8f0
  style VXC fill:#6B2D8B,stroke:#9B5DBB,color:#ffffff
  style AWS_PP fill:#1f2937,stroke:#6B2D8B,color:#e2e8f0
