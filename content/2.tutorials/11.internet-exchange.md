...
| `--asn` | Yes | Your BGP ASN — public or private (64512–65534) |
...
- Use a public ASN if you're peering for transit; private (64512–65534) is fine for closed peering arrangements
...
**Tagging**
- Apply resource tags via `ix update-tags` for cost allocation by team or environment
