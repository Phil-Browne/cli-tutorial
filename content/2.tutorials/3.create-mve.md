...
The MVE platform is integrated with: **6WIND**, **Aruba EdgeConnect**, **Aviatrix**, **Check Point CloudGuard**, **Cisco**, **Fortinet**, **Juniper**, **Palo Alto Networks**, **Peplink FusionHub**, **Versa**, **VMware SD-WAN**, **Cisco Meraki**. Each vendor exposes vendor-specific configuration fields — the common shape is below; full schema is in [Step 4](#step-4-buy-the-mve).
...
::info-card{type="warning" title="Delete attached VXCs first"}
