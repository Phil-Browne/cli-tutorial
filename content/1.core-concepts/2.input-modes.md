...
::info-card{type="tip" title="Interactive mode in the browser"}
The browser terminal answers interactive prompts inline, so `--interactive` works there too. As of v0.13 it also masks password prompts, the same way the installed CLI does.
::
