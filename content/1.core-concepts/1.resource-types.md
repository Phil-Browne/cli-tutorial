...
flowchart LR
  ...
  style P1 fill:#1f2937,stroke:#00BCD4,color:#e2e8f0
  style P2 fill:#1f2937,stroke:#00BCD4,color:#e2e8f0
  style MCR fill:#1f2937,stroke:#6B2D8B,color:#e2e8f0
  style MVE fill:#1f2937,stroke:#f59e0b,color:#e2e8f0
  style AWS fill:#1f2937,stroke:#f59e0b,color:#e2e8f0
  style AZ fill:#1f2937,stroke:#3b82f6,color:#e2e8f0
  style VXC1 fill:#6B2D8B,stroke:#9B5DBB,color:#ffffff
  style VXC2 fill:#6B2D8B,stroke:#9B5DBB,color:#ffffff
  style VXC3 fill:#6B2D8B,stroke:#9B5DBB,color:#ffffff
  style VXC4 fill:#6B2D8B,stroke:#9B5DBB,color:#ffffff
  style VXC5 fill:#6B2D8B,stroke:#9B5DBB,color:#ffffff
```
...
An **IX** connection gives you access to a public internet exchange peering point hosted at a Megaport location. Use it to establish BGP sessions with other networks and reduce transit costs.
::
...
```bash
# List available IX options
megaport-cli ix list

# Buy an IX connection
megaport-cli ix buy \
  --name "SIX Peering" \
  --port-uid <PORT-UID> \
  --vlan 1000 \
...
megaport-cli partners list --name "AWS"
megaport-cli partners list --name "Azure"
